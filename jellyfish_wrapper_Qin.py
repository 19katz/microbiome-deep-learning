...
counter =0
batch = 1
list=os.path.expanduser('~/deep_learning_microbiome/tmp_intermediate_files/') + 'Qin_batch_' + str(batch) + '.txt'  
outFile=open(list,'w')


command_file_inFN=os.path.expanduser('~/deep_learning_microbiome/tmp_intermediate_files/all_commands_qin_%smers.sh') % kmer_size
