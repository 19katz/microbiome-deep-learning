dataset=Twins
dir=/pollard/home/ngarud/shattuck/metagenomic_fastq_files/twins/fastq_files_no_adapter
...
done < ~/shattuck/metagenomic_fastq_files/twins/PRJEB9576_run_accessions_only.txt
