...
filename='/pollard/home/ngarud/shattuck/metagenomic_fastq_files/FIJI/PRJNA217052_stool_only.txt'
...
for person in metadata:
    ...
    for kmer_size in [5, 6, 7, 8, 10]:
        ...
        os.system("rm /pollard/home/ngarud/deep_learning_microbiome/data/%smers_jf/Fiji/%s_%smer.gz" %(kmer_size, person, kmer_size))

        run_accessions=metadata[person]

        for run_accession in run_accessions:
            print run_accession
            file=gzip.open('/pollard/home/ngarud/deep_learning_microbiome/data/%smers_jf/Fiji/%s_%smer.gz' %(kmer_size, run_accession, kmer_size), 'rb')
            counts=[]
            for line in file:
        ...
        outFN="/pollard/home/ngarud/deep_learning_microbiome/data/%smers_jf/Fiji/%s_%smer.gz" %(kmer_size, person, kmer_size)
