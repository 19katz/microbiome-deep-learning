...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description= "Program to run deep learning models on species datasets")
    ...
    if configFile=='none':
        ...
        config_dict=config_file.config # do I need to change this else block??
