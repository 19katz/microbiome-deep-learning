...
for k, vs in config_score.items():
    ...
    print("{}(auc+acc-loss)\t{}(auc)\t{}(acc)\t{}\t{}\t{}\t{}\t{}({})\t{}({})\t{}({})\t{}({})\t{}({})\t{}({})\t{}(ae-val-loss-std:{})\t{}(ae-mse-std:{})\t{}(auc1-{})\t{}(f1)\t{}(precision)\t{}(recall)\t{}\t(after {} test folds)".format(means[0], means[1], means[2], means[3], stds[1], stds[2], stds[3], means[4], stds[4], means[5], stds[5], means[6], stds[6], means[7], stds[7], means[8], stds[8], means[9], stds[9], means[10], stds[10], means[11], stds[11], means[12], stds[12], means[13], means[14], means[15], k, str(len(vs))))
