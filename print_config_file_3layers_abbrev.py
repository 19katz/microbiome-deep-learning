...
config['encoding_dim_1'] = [10, 50, 100] 

config['encoding_dim_2'] = [5, 10, 50] 

config['encoding_dim_3'] = [2, 5, 8] 

config['encoded_activation'] = ['relu', 'sigmoid', 'linear', 'softmax', 'tanh']

config['input_dropout_pct'] = [0, 0.25, 0.75]

config['dropout_pct'] = [0, 0.25, 0.75]
...
outFN_list=os.path.expanduser('%sconfig_files/list_of_configs_%s_3layer.txt' %(tmp_intermediate_directory, data_set) ) 
