...
data.to_pickle("/pollard/home/abustion/deep_learning_microbiome/data/pickled_dfs/Zeller5mers.pickle")
data_labels = pd.DataFrame(labels)
data_labels.to_csv("/pollard/home/abustion/deep_learning_microbiome/data/pickled_dfs/Zeller5mers.csv", header=False, index=False)
