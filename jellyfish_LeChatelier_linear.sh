dataset=LeChatelier
dir="/pollard/home/ngarud/shattuck/metagenomic_fastq_files/LeChatelier/combined_fastq_files"
...
for kmer_size in 10; do
    ...
    jellyfish count <(zcat ${dir}/${file}_1.fastq.gz) <(zcat ${dir}/${file}_2.fastq.gz) /dev/fd/0 -m ${kmer_size} -s 100M -t 10 -C -F 2 -o ~/deep_learning_microbiome/data/${kmer_size}mers_jf/${dataset}/${file}_${kmer_size}mer.jf 
...
done < ~/shattuck/metagenomic_fastq_files/LeChatelier/LeChatelier_sample_ids.txt
