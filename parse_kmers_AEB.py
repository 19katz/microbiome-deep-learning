...
def process_fastq_files(file_name_list, output_dir='/pollard/home/abustion/deep_learning_microbiome/data/data_generated',
                       n_threads=6):
    pool = Pool(n_threads)
...
# '/pollard/home/ngarud/BenNanditaProject/MIDAS_intermediate_files_hmp/joined_fastq_files_hmp_combine_sample_reps'
def process_fastq_data(file_pattern='*.fastq.gz', output_dir = '/pollard/home/abustion/deep_learning_microbiome/data/data_generated',
                       input_dir = '/pollard/home/abustion/play/dummy_files', n_threads=6):
