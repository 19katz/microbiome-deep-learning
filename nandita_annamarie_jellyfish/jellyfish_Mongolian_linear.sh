...
for kmer_size in 7; do
    ...
    jellyfish count <(zcat ${dir}/${file}-trimmed-pair1.fastq.gz) <(zcat ${dir}/${file}-trimmed-pair2.fastq.gz) /dev/fd/0 -m ${kmer_size} -s 100M -t 10 -C -F 2 -o ~/deep_learning_microbiome/data/${kmer_size}mers_jf/${dataset}/${file}_${kmer_size}mer.jf 
    ...
    # rerun jellyfish
    jellyfish count <(zcat ${dir}/${file}-trimmed-pair1.fastq.gz) <(zcat ${dir}/${file}-trimmed-pair1.fastq.gz) /dev/fd/0 -m $kmer_size -s 100M -t 10 -C -F 2 -o ~/deep_learning_microbiome/data/${kmer_size}mers_jf/${dataset}/${file}_${kmer_size}mer.jf
