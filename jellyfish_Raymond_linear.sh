...
for kmer_size in 7 8; do
    ...
    jellyfish count <(zcat ${dir}/${file}-trimmed-pair1.fastq.gz) <(zcat ${dir}/${file}-trimmed-pair2.fastq.gz) /dev/fd/0 -m ${kmer_size} -s 100M -t 2 -C -F 2 -o ~/deep_learning_microbiome/data/${kmer_size}mers_jf/${dataset}/${file}_${kmer_size}mer.jf 
    ...
    # rerun jellyfish
    jellyfish count <(zcat ${dir}/${file}-trimmed-pair1.fastq.gz) <(zcat ${dir}/${file}-trimmed-pair1.fastq.gz) /dev/fd/0 -m $kmer_size -s 100M -t 2 -C -F 2 -o ~/deep_learning_microbiome/data/${kmer_size}mers_jf/${dataset}/${file}_${kmer_size}mer.jf
...
done < /pollard/home/ngarud/shattuck/metagenomic_fastq_files/Raymond_2016/day0_patient_ids.txt
