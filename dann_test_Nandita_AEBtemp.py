...
kmer_size=3 #change depending on datset to be loaded
...
data.to_pickle("/pollard/home/abustion/deep_learning_microbiome/data/pickled_dfs/3mers_zeller.pickle")
data_labels = pd.DataFrame(labels)
data_labels.to_csv("/pollard/home/abustion/deep_learning_microbiome/data/pickled_dfs/3mers_zeller.csv", header=False, index=False)
